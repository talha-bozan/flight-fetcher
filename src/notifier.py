...
def smtp_self_test() -> tuple[bool, str]:
    ...
    try:
        ...
        return False, (
            ...
            f"Login user was {config.SMTP_USER}. Check that the SMTP_USER and "
            f"SMTP_PASSWORD secrets match what your provider gave you. "
            f"For Brevo: app.brevo.com/settings/keys/smtp"
        )
